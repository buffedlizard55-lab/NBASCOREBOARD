...
| `python-browser-headers` | 200 | 375 | ok |
| `python-pages-origin` | 403 | 445 | HTTPError 403 |
| `python-no-referer` | 403 | 443 | HTTPError 403 |
| `curl-default` | 403 | 446 |  |
| `curl-browser-headers-http2` | 200 | 363 | ok |
...
|---|---|---|---|---|
| `allorigins-raw` | 522 | 7259 | None | - |
| `codetabs` | 503 | 7108 | None | - |
